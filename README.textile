...
* Added: Arrays are returned as sanitized string and can be passed from one tag instance to other. Sanitized output can be extracted by prefixing used tag attribute name with @_sanitized@.
